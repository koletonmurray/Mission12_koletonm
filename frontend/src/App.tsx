...
// A Constant varaiable that holds the json data for all the NCAA Teams
const teams = [
...
// Adds the following heading with some spacing around it 
function Heading(){
  return (
    <div>
      <br/>
...
// Takes in the data for each individual team from the json object and places it within card styling.
// It displays the school, mascot, and location as required
    ...
    return (
      <div className="card team-card">
        <div className="card-body">
          <h2 className="card-title text-white">{oneTeam.school}</h2>
          <h3 className="card-subtitle mb-2 text-white">{oneTeam.name}</h3>
...
// Generates a list of all the teams and contains them all together.
function TeamList() {
  return (
    <div className="row">
      {teams.map((oneTeam) => (
...
// Main function that takes the heading and the teamlist and send render it to the index page
// I left the react logo that spins because it's cool and very satisying
function App() {
  return (
    <div className="App">
